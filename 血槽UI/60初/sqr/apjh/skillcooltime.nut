				...
				else
				{
					...
					if ( ( id >= 0 && id < 6 ) )
					{
						...
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 603 + id * 30, 572, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 603 + id * 30, 572, curCoolTime / 100 );
					}
					else if ( ( id >= 198 && id < 204 ) )
					{
						...
						local curCoolTime = coolTime - ( currentT - apd.getVar ( "saveSkillOkTime" ).get_vector ( i ) );
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 600 + id * 30, 538, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 600 + id * 30, 538, curCoolTime / 100 );
					}
					...
					else
					{
						...
						local lastX = 591 + offsetX;
						local lastY = 500 + offsetY;
