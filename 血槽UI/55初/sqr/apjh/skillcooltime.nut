				...
				else
				{
					...
					if ( ( id >= 0 && id < 6 ) )
					{
						...
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 635 + id * 35, 575, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 635 + id * 35, 575, curCoolTime / 100 );
					}
					else if ( ( id >= 198 && id < 204 ) )
					{
						...
						local curCoolTime = coolTime - ( currentT - apd.getVar ( "saveSkillOkTime" ).get_vector ( i ) );
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 635 + id * 35, 537, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 635 + id * 35, 537, curCoolTime / 100 );
					}
					...
					else
					{
						...
						local lastX = 623 + offsetX;
						local lastY = 496 + offsetY;
