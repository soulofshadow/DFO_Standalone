				...
				else
				{
					...
					if ( ( id >= 0 && id < 6 ) )
					{
						...
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 450 + id * 30, 574, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 450 + id * 30, 574, curCoolTime / 100 );
					}
					else if ( ( id >= 198 && id < 204 ) )
					{
						...
						local curCoolTime = coolTime - ( currentT - apd.getVar ( "saveSkillOkTime" ).get_vector ( i ) );
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 448 + id * 30, 544, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 448 + id * 30, 544, curCoolTime / 100 );
					}
					else if(newidc>0&&newidc==i)
					{
						...
						if ( curCoolTime >= 10000 ){
							drawSirocoUINumberWithPos ( obj, 634, 543, curCoolTime / 1000 );
						}
						else{
							if(curCoolTime < 100)
							{
							...
							drawSirocoUINumberWithPosPoint ( obj, 634, 543, curCoolTime / 100 );	
						}
					...
					else if(newida>0&&newida==i)
					{
						...
						if ( curCoolTime >= 10000 ){
							drawSirocoUINumberWithPos ( obj, 634, 573, curCoolTime / 1000 );
						}
						else{
							if(curCoolTime < 100)
							{
							...
							drawSirocoUINumberWithPosPoint ( obj, 634, 573, curCoolTime / 100 );	
						}
					}
					else
					{
