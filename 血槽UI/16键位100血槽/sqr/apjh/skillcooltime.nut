				...
				else
				{
					...
					if ( ( id >= 0 && id < 6 ) )
					{
						...
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 440 + id * 30, 574, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 440 + id * 30, 574, curCoolTime / 100 );
					}
					else if ( ( id >= 198 && id < 204 ) )
					{
						...
						local curCoolTime = coolTime - ( currentT - apd.getVar ( "saveSkillOkTime" ).get_vector ( i ) );
						if ( curCoolTime >= 10000 )
							drawSirocoUINumberWithPos ( obj, 438 + id * 30, 544, curCoolTime / 1000 );
						else
							drawSirocoUINumberWithPosPoint ( obj, 438 + id * 30, 544, curCoolTime / 100 );
					}
					else if(newidc>0&&newidc==i)
					{
						...
						if ( curCoolTime >= 10000 ){
							drawSirocoUINumberWithPos ( obj, 624, 543, curCoolTime / 1000 );
						}
						else{
							if(curCoolTime < 100)
							{
							...
							drawSirocoUINumberWithPosPoint ( obj, 624, 543, curCoolTime / 100 );	
						}
					...
					else if(newida>0&&newida==i)
					{
						...
						if ( curCoolTime >= 10000 ){
							drawSirocoUINumberWithPos ( obj, 624, 573, curCoolTime / 1000 );
						}
						else{
							if(curCoolTime < 100)
							{
							...
							drawSirocoUINumberWithPosPoint ( obj, 624, 573, curCoolTime / 100 );	
						}
					}
					else
					{
						...
						local lastX = 423 + offsetX;
						local lastY = 498 + offsetY;
...
function NewSkillCoolTimeShadow( obj, coolTime,curCoolTime, alt){
	...
	local shadow = sq_CreateAnimation("", "sqr/custom/ani//disable.ani");
